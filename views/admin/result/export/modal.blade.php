    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5">{{ trans('generate-form-register::export.gfr.title') }}</h1>
                ...
                <div class="modal-body" style="overflow-x:auto; max-height:500px;">
                    <div class="form-group">
                        <label class="form-check radio d-block mb-2">
                            <input type="radio" name="exportType" value="pageCurrent" class="form-check-input" checked> {{trans('generate-form-register::export.options.page')}}
                        </label>
                        <label class="form-check radio d-block mb-2">
                            <input type="radio" name="exportType" value="check" class="form-check-input"> {{trans('generate-form-register::export.options.check')}}
                        </label>
                        <label class="form-check radio d-block mb-2">
                            <input type="radio" name="exportType" value="searchCurrent" class="form-check-input"> {{trans('generate-form-register::export.options.search')}}
                        </label>
                    </div>
                </div>
                <div class="modal-footer">
                    <button class="btn btn-white" type="button" data-bs-dismiss="modal" aria-label="Close">{{trans('button.cancel')}}</button>
                    <button class="btn btn-blue" type="button" id="js_export_form_register_result_btn_submit"><i class="fa-light fa-download"></i> {{trans('generate-form-register::export.data')}}</button>
                </div>
            </div>
            <div id="js_export_form_register_result_result" style="display:none;">
                <div class="modal-body">
                    <a href="" class="btn btn-blue btn-blue-bg" download><i class="fa-duotone fa-file-excel"></i> {{trans('generate-form-register::export.button.download')}}</a>
    ...
    $(function () {
        class ExportFormResultHandel {
            ...
            export(element) {
                ...
                data.action = 'FormRegister\\Ajax\\Admin\\FormRegisterAjax::export';
