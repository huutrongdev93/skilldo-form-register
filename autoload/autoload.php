...
class ClassAutoLoad {
    ...
    protected string $name = 'generate-form-register';
    ...
    {
        if($class === "FormRegister\\Model\\Form")
        {
            $classMaps[$class] = FCPATH.VIEWPATH.'plugins/'.$this->name.'/include/models/form-register.php';
        }
